def call(script) {
  ...
  script.bat "docker run -v datosowasp1:/zap/wrk/:rw --network java_network --user root -t owasp/zap2docker-stable zap-full-scan.py -t http://javacontainer:8081 -r datosowasp1.html -a"  
}