def call(script) {
  ...
  def exitCode = bat(script: 'script.bat "docker run -v datosowasp1:/zap/wrk/:rw --network java_network --name owasp-container --user root -t owasp/zap2docker-stable zap-full-scan.py -t http://javacontainer:8080 -r datosowasp1.html"', returnStatus: true)
  if (exitCode == 2) {
